...
const _protectedRoutes = [
  ...
  ('finding_perfect', '/finding-perfect', <String, dynamic>{'bookingId': 0, 'ShootTypeId': 0, 'contentTypeId': 0}),
  ...
  ('more_details', '/more-details', <String, dynamic>{'contentTypeId': 0, 'ShootTypeId': 0, 'bookingId': 0}),
  ('crew_size_matching', '/crew-size-matching', <String, dynamic>{'ShootTypeId': 0, 'bookingId': 0, 'contentTypeId': 0}),
  ('select_dream_team', '/select-dream-team', <String, dynamic>{'ShootTypeId': 0, 'bookingId': 0, 'contentTypeId': 0}),
