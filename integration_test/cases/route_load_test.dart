...
const _protectedRoutes = [
  ...
  (
    'finding_perfect',
    '/finding-perfect',
    <String, dynamic>{'bookingId': 0, 'ShootTypeId': 0, 'contentTypeId': 0},
  ),
  ('payment_method', '/payment-method/999', null),
  ('content_type', '/content-type', <String, dynamic>{'value': 0}),
  (
    'video_shoot_type',
    '/video-shoot-type',
    <String, dynamic>{'contentTypeId': 0, 'bookingId': 0},
  ),
  (
    'shoot_date_time',
    '/shoot-date-time',
    <String, dynamic>{'ShootTypeId': 0, 'bookingId': 0, 'contentTypeId': 0},
  ),
  (
    'more_details',
    '/more-details',
    <String, dynamic>{'contentTypeId': 0, 'ShootTypeId': 0, 'bookingId': 0},
  ),
  (
    'crew_size_matching',
    '/crew-size-matching',
  ...
  (
    ...
    '/booking-summary/999',
    <String, dynamic>{'contentType': 'Video', 'shootTypeId': 1},
  ),
  (
    'manage_booking',
    '/manage-booking/999',
  ...
  (
    ...
    <String, String>{'email': 'test@example.com', 'otp': '1234'},
  ),
  ...
  group('Route Load Tests — Public Routes', () {
    for (final (name, path, extra) in _publicRoutes) {
      testWidgets('$name loads without crash', (tester) async {
        ...
        report.record(route: path, routeName: name, loadResult: loadResult);
