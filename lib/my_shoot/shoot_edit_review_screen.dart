...
class ShootEditReviewScreen extends StatefulWidget {
  final int bookingId;

  const ShootEditReviewScreen({super.key, required this.bookingId});

  @override
  State<ShootEditReviewScreen> createState() => _ShootEditReviewScreenState();
}

class _ShootEditReviewScreenState extends State<ShootEditReviewScreen> {
