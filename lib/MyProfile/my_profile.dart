...
class _MyProfileState extends State<MyProfile> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _menuRow("assets/images/Heart Angle.png", "Favourites"),
                _divider(),
                _menuRow("assets/Icons/calendar_search.png", "Booking History"),
                _divider(),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _divider(),
                _menuRow("assets/Icons/Exit.png", "Logout"),
              ],
            ),
          ),
        ],
  ...
  Widget _menuRow(String iconPath, String title) {
    return InkWell(
      borderRadius: BorderRadius.circular(20),
      onTap: () {
        // TODO: navigation
            ...
            Container(
              ...
              child: Center(
                child: Image.asset(
                  ...
                  height: 22,
                  width: 22,
                  color: ColorCode.white, // remove if image is colored
                ),
              ),
            ),
