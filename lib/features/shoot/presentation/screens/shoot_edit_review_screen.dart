...
class ShootEditReviewScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ShootEditReviewScreen> createState() => _ShootEditReviewScreenState();
}
...
class _ShootEditReviewScreenState extends ConsumerState<ShootEditReviewScreen> {
  ...
  Widget build(BuildContext context) {
    final reviewState = ref.watch(shootEditReviewNotifierProvider(widget.bookingId));
