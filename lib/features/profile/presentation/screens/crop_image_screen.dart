...
class _CropImageScreenState extends State<CropImageScreen> {
  ...
  Future<File?> _cropImage() async {
    ...
    final canvasCenterX =
        (outSize / 2.0) + (clampedOffset.dx * uiToCanvasScale);
    final canvasCenterY =
        (outSize / 2.0) + (clampedOffset.dy * uiToCanvasScale);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            /// HEADER TITLE & BACK BUTTON (Matching other screens with AppAssets.back)
            Padding(
