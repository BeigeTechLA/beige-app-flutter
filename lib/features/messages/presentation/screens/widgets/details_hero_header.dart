...
/// Avatar straddles the boundary between the beige hero and the dark body;
/// room name renders below on the dark surface. Avatar always shows initials
/// derived from the room name (no contact image).
