...
class _MessageGestureWrapperState extends State<MessageGestureWrapper>
  ...
  /// System messages skip gesture handling entirely — no reply/react semantics.
  bool get _isInteractive => widget.message.type != MessageType.system;

  /// Peer bubbles swipe right (drag > 0). Own bubbles swipe left (drag < 0).
  /// Same-direction drag away from the reveal zone is clamped to 0.
  ...
  void _onDragUpdate(DragUpdateDetails d) {
    ...
    if (reached != _thresholdReached) {
      ...
      // Light haptic on threshold crossing — matches WhatsApp feel.
    }
