...
/// Returns via `Navigator.pop(context, MessageAction.reaction, payload: emoji)`
/// through the [MessageActionResult] sealed shape so the caller can pattern
            ...
            _ActionCard(
              children: [
                _ActionTile(
                  ...
                  label: 'Reply',
                  onTap: () =>
                      Navigator.of(context).pop(MessageActionResult.reply()),
                ),
              ],
            ),
            const SizedBox(height: AppSpacing.sm),
