...
/// Cleared on logout via [clear] (invoked from `SharedService.logout`).
class UnreadStore {
  ...
  /// Flushes pending debounced write immediately + drops the key. Called from
  /// logout so the next user starts fresh.
