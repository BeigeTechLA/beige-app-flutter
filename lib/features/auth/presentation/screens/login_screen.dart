...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void initState() {
    super.initState();
    if (kDebugMode) {
      emailController.text = 'parth@revurge.com';
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(loginNotifierProvider, (prev, next) {
      ...
      if (next.status == LoginStatus.error && next.errorMessage != null) {
        if (emailController.text.isEmpty && _lastSubmittedEmail.isNotEmpty) {
          emailController.text = _lastSubmittedEmail;
        }
        if (passwordController.text.isEmpty &&
            _lastSubmittedPassword.isNotEmpty) {
          passwordController.text = _lastSubmittedPassword;
        }
