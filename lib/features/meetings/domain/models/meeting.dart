...
class Meeting {
  ...
  /// Per-user RSVP map, keyed by userId (stringified). Mirrors the server
  /// `participant_responses` array — entry shape: `{ user_id, response }`.
  /// Unknown / unmapped values are dropped at the DTO boundary.
