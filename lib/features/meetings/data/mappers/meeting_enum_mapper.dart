...
/// `completed` plausible but never observed. Server `meeting_type` (observed):
/// `post_production` only — open enum.
///
...
class MeetingEnumMapper {
  ...
  /// Backend has not published the full `meeting_type` set. All observed
