...
class _AppSearchFieldState extends State<AppSearchField> {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveFill = widget.fillColor ?? AppColors.surfaceInput;
    final effectiveBorderColor = widget.borderColor ??
        (isFocused ? AppColors.primary : AppColors.dividerDark);
    final effectiveRadius = widget.borderRadius ?? AppRadii.lgAll;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isFocused ? AppColors.primary : effectiveBorderColor,
