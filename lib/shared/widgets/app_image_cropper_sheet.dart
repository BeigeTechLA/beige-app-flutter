...
class AppImageCropperSheet extends StatefulWidget {
  ...
  @override
  State<AppImageCropperSheet> createState() => _AppImageCropperSheetState();
}

class _AppImageCropperSheetState extends State<AppImageCropperSheet> {
  ...
  static const double _circleDiameter = 260.0;
  static const double _backdropBoxSize = 310.0;
  ...
  Offset _clampOffset(Offset rawOffset, double userScale) {
    ...
    // Allows any corner or edge of the photo to be moved smoothly into the circle lens
  ...
  Future<File?> _cropImage() async {
    ...
    if (turns != 0) {
      final rotW = (turns % 2 == 1)
          ? workingImage.height
          : workingImage.width;
      final rotH = (turns % 2 == 1)
          ? workingImage.width
          : workingImage.height;
    ...
    return Container(
      ...
      child: Column(
        children: [
                ...
                : GestureDetector(
                    ...
                    onScaleUpdate: (details) {
                      setState(() {
                        ...
                        _offset = _clampOffset(_startOffset + delta, nextScale);
                      });
                    },
                    child: Column(
          ...
          /// EXISTING PRIMARY ACTION BUTTON ("Save Profile Photo")
          Padding(
            padding: const EdgeInsets.symmetric(
              horizontal: AppSpacing.base,
